# -*- coding: utf-8 -*-
"""
Created on Sun Apr 08 12:11:14 2018
...
test_dir = 'subsetData/test'
train_samp_size = 5000
test_samp_size = 1500
...
plt.figure()
N = epochs
plt.plot(np.arange(0, N), aniModel.history["loss"], label="train_loss")
plt.plot(np.arange(0, N), aniModel.history["val_loss"], label="val_loss")
plt.plot(np.arange(0, N), aniModel.history["acc"], label="train_acc")
plt.plot(np.arange(0, N), aniModel.history["val_acc"], label="val_acc")
